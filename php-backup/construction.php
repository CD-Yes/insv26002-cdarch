...
<section class="page-header   appear-animation" data-appear-animation="fadeIn" data-plugin-parallax data-plugin-options="{'speed': 1.5, 'parallaxHeight': '120%', 'offset': 60}" data-image-src="admin/content/upload/slider.png">
...
<div class="row">
<div class="col-md-12">
<h1 class="font-weight-bold text-color-light">Construction</h1>
</div>
</div>
</div>
</section>
...
<img src="admin/content/upload/oi.png" width="350px" height="262px" class="position-absolute" alt="" data-plugin-float-element data-plugin-options="{'startPos': 'none', 'speed': 9, 'horizontal': true, 'transition': true, 'style': 'top: 0px; right: -40%;     width: 350px;    height: 262px;'}" />
<img src="admin/content/upload/home.png" class="position-absolute" alt="" data-plugin-float-element data-plugin-options="{'startPos': 'none', 'speed': 8.5, 'transition': true, 'style': 'bottom: -40px; left: -40%;width: 350px;    height: 262px;'}" />
</div>
</div>
<div class="col-md-6">
...
<h2 class="font-weight-bold text-6 mb-3">Construction Works</h2>
</div>
<p class="text-color-light-3 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500">CD Architecture  is one amongst the simplest construction company in Erode. The goal is to supply an expert bit to construction services that exceeds client expectations.</p>
<p class="text-color-light-3 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800"> Timeline, Pre-construction management, Planning, planning and Execution are the core space of focus and therefore the consumer will bank on excellence from CD design   through its older professionals. </p>
<a href="contact.php" class="btn btn-outline btn-rounded btn-primary btn-v-3 btn-h-4 font-weight-bold text-0 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000">CONTACT US</a>
</div>
</div>
</div>
</section>
...
<div class=" mb-4 pb-3">
<a href="content_construction.php?name=2">
<img src="admin/content/upload/construction2.png" style="width:350px;height:262px;"  alt="">
</a>
</div>
<h2 class="text-4 font-weight-bold mb-3"></h2>
<p></p>
</div>
<div class="col-md-4 text-center mb-5 mb-md-0">
<div class=" mb-4 pb-3">
<a href="content_construction.php?name=3">
<img src="admin/content/upload/construction3.png" style="width:350px;height:262px;"  alt="">
</a>
</div>
<h2 class="text-4 font-weight-bold mb-3"></h2>
<p></p>
...
<div class="col-md-4 text-center mb-5 mb-md-0">
<div class=" mb-4 pb-3">
<a href="content_construction.php?name=4">
<img src="admin/content/upload/construction4.png" style="width:350px;height:262px;"  alt="">
</a>
</div>
<h2 class="text-4 font-weight-bold mb-3"></h2>
<p></p>
...
<div class="col-md-4 text-center mb-5 mb-md-0">
<div class=" mb-4 pb-3">
<a href="content_construction.php?name=5">
<img src="admin/content/upload/construction5.png" style="width:350px;height:262px;"  alt="">
</a>
</div>
<h2 class="text-4 font-weight-bold mb-3"></h2>
<p></p>
...
<div class="col-md-4 text-center mb-5 mb-md-0">
<div class=" mb-4 pb-3">
<a href="content_construction.php?name=6">
<img src="admin/content/upload/construction6.png" style="width:350px;height:262px;"  alt="">
</a>
</div>
<h2 class="text-4 font-weight-bold mb-3"></h2>
<p></p>
...
<img src="img/generic/generic-2.jpg" class="img-fluid" alt=""style="width:350px;height:262px;">
</div>
<h2 class="text-4 font-weight-bold mb-3">Mobile Apps</h2>
<p>Phasellus blandit massa enim. Nullam id varius nunc. Lorem ipsum dolor sit amet, consectetur adipiscing...</p>
</div>
<div class="col-md-4 text-center">
<div class="image-frame image-frame-style-3 mb-4 pb-3">
<img src="img/generic/generic-3.jpg" class="img-fluid" alt="">
</div>
<h2 class="text-4 font-weight-bold mb-3">SEO Optimization</h2>
<p>Phasellus blandit massa enim. Nullam id varius nunc. Lorem ipsum dolor sit amet, consectetur adipiscing...</p>
</div>-->
</div>
</div>
...
<img width="42" height="42" src="vendor/linear-icons/tablet.svg" alt="" data-icon data-plugin-options="{'color': '#2388ED', 'animated': true}" />
</div>
<div class="icon-box-info">
<div class="icon-box-info-title">
<h4>Mobile Apps</h4>
</div>
<p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim. Nullam id varius nunc.</p>
</div>
</div>
</div>
</div>
<div class="col-sm-6 col-lg-4 appear-animation" data-appear-animation="fadeInUpShorter">
<div class="icon-box-animation-1">
<div class="icon-box icon-box-style-6">
<div class="icon-box-icon">
<img width="42" height="42" src="vendor/linear-icons/select.svg" alt="" data-icon data-plugin-options="{'color': '#2388ED', 'animated': true, 'delay': 600}" />
</div>
<div class="icon-box-info">
<div class="icon-box-info-title">
...
<div class="col-sm-6 col-lg-4 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="400">
<div class="icon-box-animation-1">
<div class="icon-box icon-box-style-6">
<div class="icon-box-icon">
<img width="42" height="42" src="vendor/linear-icons/magnifier.svg" alt="" data-icon data-plugin-options="{'color': '#2388ED', 'animated': true, 'delay': 1200}" />
</div>
<div class="icon-box-info">
<div class="icon-box-info-title">
...
<h2 class="font-weight-extra-bold position-relative text-color-light text-4 bg-dark-5 mt-negative-2 mb-4">STRATEGY</h2>
<p class="text-color-light-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim. Nullam id varius.</p>
</div>
</div>
<div class="col-md-4 mb-5 mb-md-0">
<div class="px-4">
<span class="font-weight-bold text-color-primary font-primary text-18">2</span>
<h2 class="font-weight-extra-bold position-relative text-color-light text-4 bg-dark-5 mt-negative-2 mb-4">PLANNING</h2>
<p class="text-color-light-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim. Nullam id varius.</p>
</div>
</div>
<div class="col-md-4">
...
<h2 class="font-weight-extra-bold position-relative text-color-light text-4 bg-dark-5 mt-negative-2 mb-4">BUILD</h2>
<p class="text-color-light-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim. Nullam id varius.</p>
</div>
</div>
</div>
...
<div class="col-md-4 text-center mb-5 mb-md-0">
<div class="image-frame image-frame-style-3 mb-4 pb-3">
<img src="img/generic/generic-1.jpg" class="img-fluid" alt="">
</div>
...
<div class="col-md-4 text-center mb-5 mb-md-0">
<div class="image-frame image-frame-style-3 mb-4 pb-3">
<img src="img/generic/generic-2.jpg" class="img-fluid" alt="">
</div>
<h2 class="text-4 font-weight-bold mb-3">Mobile Apps</h2>
<p>Phasellus blandit massa enim. Nullam id varius nunc. Lorem ipsum dolor sit amet, consectetur adipiscing...</p>
</div>
...
<span class="d-block top-sub-title text-color-primary appear-animation" data-appear-animation="maskUp">THE RIGHT CHOICE</span>
</div>
<div class="overflow-hidden mb-2">
<h2 class="font-weight-bold text-5 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="200">Small details make difference</h2>
</div>
<div class="overflow-hidden mb-3">
<p class="lead mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="400">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit.</p>
</div>
</div>
</div>
<div class="row">
<div class="col-md-4 col-lg-5 mr-auto mb-4 mb-md-0 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="600">
...
<div class="col-md-4 col-lg-3 pl-md-4 pl-lg-0 mb-4 mb-md-0 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="800">
...
<div class="col-md-4 col-lg-3 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="1000">
...
<li class="d-flex align-items-center text-2 pb-1 mb-2"><i class="fas fa-check text-color-primary text-2 mr-2"></i> Lorem ipsum dolor sit amet.</li>
<li class="d-flex align-items-center text-2 pb-1 mb-2"><i class="fas fa-check text-color-primary text-2 mr-2"></i> Dolor sit amet, consectetur adipiscing elit.</li>
<li class="d-flex align-items-center text-2 pb-1 mb-2"><i class="fas fa-check text-color-primary text-2 mr-2"></i> Sit amet, consectetur adipiscing elit.</li>
<li class="d-flex align-items-center text-2 pb-1 mb-2"><i class="fas fa-check text-color-primary text-2 mr-2"></i> Ipsum dolor sit amet, consectetur adipiscing elit.</li>
<li class="d-flex align-items-center text-2"><i class="fas fa-check text-color-primary text-2 mr-2"></i> Consectetur adipiscing elit.</li>
</ul>
</div>
</div>
</section>
...
<div class="parallax section min-height-370 h-100" data-plugin-parallax data-plugin-options="{'speed': 1.5}" data-image-src="img/parallax/parallax-4.jpg"></div>
</div>
</div>
</div>
<section class="section">
...
<div class="col">
<div class="overflow-hidden">
<span class="d-block top-sub-title text-color-primary d-block appear-animation" data-appear-animation="maskUp">OUR ROCKSTARS</span>
</div>
<div class="overflow-hidden">
